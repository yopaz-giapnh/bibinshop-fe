 ...
 */
import type { CreditCardRelationshipsPaymentMethod } from './creditCardRelationshipsPaymentMethod';

export type CreditCardRelationships = {
  payment_method?: CreditCardRelationshipsPaymentMethod;
};
