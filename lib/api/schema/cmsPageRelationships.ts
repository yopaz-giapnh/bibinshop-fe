 ...
 */
import type { CmsPageRelationshipsCmsSections } from './cmsPageRelationshipsCmsSections';

export type CmsPageRelationships = {
  cms_sections?: CmsPageRelationshipsCmsSections;
};
