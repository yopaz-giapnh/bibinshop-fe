 ...
 */
import type { VariantRelationshipsImages } from './variantRelationshipsImages';
import type { VariantRelationshipsOptionValues } from './variantRelationshipsOptionValues';
import type { VariantRelationshipsProduct } from './variantRelationshipsProduct';

export type VariantRelationships = {
  images?: VariantRelationshipsImages;
  option_values?: VariantRelationshipsOptionValues;
  product?: VariantRelationshipsProduct;
};
