 ...
 */
import type { PaymentRelationshipsPaymentMethod } from './paymentRelationshipsPaymentMethod';
import type { PaymentRelationshipsSource } from './paymentRelationshipsSource';

export type PaymentRelationships = {
  payment_method?: PaymentRelationshipsPaymentMethod;
  source?: PaymentRelationshipsSource;
};
