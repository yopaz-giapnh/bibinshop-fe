...
export type CreditCardAttributesCcType =
  (typeof CreditCardAttributesCcType)[keyof typeof CreditCardAttributesCcType];

// eslint-disable-next-line @typescript-eslint/no-redeclare
export const CreditCardAttributesCcType = {
  visa: 'visa',
