 ...
 */
import type { DigitalLinkRelationshipsLineItem } from './digitalLinkRelationshipsLineItem';

export type DigitalLinkRelationships = {
  line_item?: DigitalLinkRelationshipsLineItem;
};
