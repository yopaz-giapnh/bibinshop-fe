 ...
 */
import type { WishedItemAttributes } from './wishedItemAttributes';
import type { WishedItemRelationships } from './wishedItemRelationships';

export interface WishedItem {
  attributes: WishedItemAttributes;
  id: string;
  relationships: WishedItemRelationships;
  type: string;
}
