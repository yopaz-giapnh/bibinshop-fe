 ...
 */
import type { DigitalLinkAttributes } from './digitalLinkAttributes';
import type { DigitalLinkRelationships } from './digitalLinkRelationships';

/**
 * Digital links are accessible in the order includes line_items.digital_links
 */
export interface DigitalLink {
  attributes?: DigitalLinkAttributes;
  id?: string;
  relationships?: DigitalLinkRelationships;
  type?: string;
}
