 ...
 * @returns JSX.Element
 */
export default function MessageSeeMoreModal({ message, vendor, vendorImageUrl, date }: Props) {
  const [state, formAction] = useFormState(getAccountMessageDetail, null);
  const action = formAction.bind(null, message.id);
