    ...
    <div className="mx-auto max-w-4xl rounded-xl bg-white-base p-8">
      ...
      <div className="space-y-8">
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="leading-relaxed">
                本規約は、弊社及び会員、並びに会員相互間の関係を規律することをもって、bibin
            ...
            <div>
              ...
              <div className="mt-2 space-y-2 pl-6">
                ...
                <div className="flex gap-4">
                  <span>⑤</span>
                  <span>
                    その他弊社が営本サービスに関する状況に照らして合理的に中断が必要と判断した場合
                  </span>
                </div>
              </div>
            </div>
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <ol className="list-decimal space-y-2 pl-6">
                ...
                <li>
                  弊社は、会員情報及び取引情報（以下「会員情報等」という。）を取引の履行及び本サービスの提供の目的でのみ使用し、次の各号に該当する場合を除き、会員の同意なしに会員情報等を第三者に提供しない。
                  <div className="mt-2 space-y-2 pl-6">
                    <div className="flex gap-4">
                      <span>①</span>
                      <span>
                        法令によって会員情報等の開示を命じられた場合、又は法令上第三者に対して提供が許容される場合
                      </span>
                    </div>
                    <div className="flex gap-4">
                      <span>②</span>
                      <span>配送業務のため等、取引の履行のために会員情報等の開示が必要な場合</span>
                    </div>
                    <div className="flex gap-4">
                      <span>③</span>
                      <span>会員情報等の開示につき、当該会員の同意を得た場合</span>
                    </div>
                  </div>
                </li>
              </ol>
            ...
            <div>
              ...
              <ol className="list-decimal space-y-2 pl-6">
                ...
                <li>
                  退会する会員は、弊社に対して債務を負っている場合、弁済期の如に関わらず直ちに、全てを弁済しなければならないことについて、予め承知する。
                </li>
                <li>
        ...
        <section>
          ...
          <div className="space-y-6">
            <div>
              ...
              <ol className="list-decimal space-y-2 pl-6">
                <li>
                  本サービスを通じて利用者が商品を注文し、出品者がこれに同意することで利用者と商品提供者との間に取引契約が成立する。
                </li>
                <li>
                  利用者が同時に複数商品を注文する場合、当該注文及びこれに対する出品者の同意は本サービス上の注文番号単位で行われたものとみなし、取引の成立単位もこれに倣う。
                </li>
                <li>
                  利用者が海外（商品の送付先所在する国の領域外をいう。以下同じ。）から発送される商品を注文する場合、当該商品を国内に輸入、及び販売し得るものであるか否かについて、利用者の責任と負担において確認を実施する。
                </li>
                <li>
            ...
            <div>
              ...
              <p className="leading-relaxed">
                利用者は、本サービス上に表示する支払期限までに、同表示する支払方法により、第7条に基づき成立した契約に係る売買代金（但し、海外から商品が発送される場合は関税費用を含む）を支払う。
              </p>
            </div>
            ...
            <div>
              ...
              <p className="leading-relaxed">
                商品の所有権は、利用者が商品の引渡しを受けた（手渡しで受領した場合に限らず、利用者の管理権限の及ぶ領域に商品が到達した場合を広く含む。以下同じ。）時点で移転するものとし、以降に生じた商品の滅失又は毀損に関する危険は利用者が負担する。
              </p>
            </div>
              ...
              <ol className="list-decimal space-y-2 pl-6">
                <li>
                  ...
                  <div className="mt-2 space-y-2 pl-6">
                    ...
                    <div className="flex gap-4">
                      <span>③</span>
                      <span>時間の経過により商品の価値が減し、再販売が著しくなった場合</span>
                    </div>
                    <div className="flex gap-4">
                      <span>④</span>
                ...
                <li>
                  払戻しは、購入時の決済手段に応じた方法で行うものとし、利用者は必要に応じ弊社の指示に従う。その際、払い戻しのために必要な振込手数料が発生するときは、利用者がこれを負担するお、払い戻される金銭に対して利息は発生しない。
                </li>
              </ol>
            </div>
          </div>
            ...
            <div>
              ...
              <div className="space-y-2 pl-6">
                ...
                <div className="flex gap-4">
                  <span>③</span>
                  <span>
                    指定プラットフォームで開始された取引を指定プラットフォーム以外で完了させ、又は完了させようとする行為
                  </span>
                </div>
                <div className="flex gap-4">
                  <span>④</span>
        ...
        <section>
          <div className="space-y-6">
            <div>
              <h3 className="mb-2">第18条 （規約の変更等）</h3>
              <ol className="list-decimal space-y-2 pl-6">
                <li>
                  弊社は、必要な場合、特定のサービス又は状況に適用される補足規則及び方針を定めることができる。これらの補足規則及び方針、並びに指定プラットフォーム上に記載された公示、利用案内及び注意事項は本規約の一部を構成する。
                </li>
                <li>
                  弊社は、本規約を自ら任意に改定することができ、改定された本規約が指定プラットフォーム上に掲載された時点でその効力が発生するものとする。本規約改定後、会員が指定プラットフォーム又は本サービスを利用する場合、利用者は改定された本規約を遵守することに同意したものとみなされる。
                </li>
                <li>
            ...
            <div>
              <h3 className="mb-2">第19条 （事業者の損害賠償責任の免除）</h3>
              <ol className="list-decimal space-y-2 pl-6">
                <li>
                  次の各号に定める損害は、当該損害が弊社の故意又は過失に起因する場合を除き、当該損害を被った会員が負担する。また、当該損害が弊社の軽過失に起因する場合、弊社の賠償の範囲は、当該損害が発生した日から遡り直近12か月間に当該損害を被った会員が弊社に対して支払ったサービス利用料の総額を超えない範囲に限られる。
                  <div className="mt-2 space-y-2 pl-6">
                    <div className="flex gap-4">
                      <span>①</span>
                      <span>
                    ...
                    <div className="flex gap-4">
                      <span>⑧</span>
                      <span>
                        通信障害等の技術的な問題により本サービスが一時的又は恒久的に利用できなくなることに関連又は起因して会員に生じた損害
                      </span>
                    </div>
                    <div className="flex gap-4">
                      <span>⑨</span>
            ...
            <div>
              <h3 className="mb-2">第20条 （会員に対する損害賠償）</h3>
              <p className="leading-relaxed">
            ...
            <div>
              <h3 className="mb-2">第21条 （準拠法・専属的合意管轄）</h3>
              <p className="leading-relaxed">
            ...
            <div className="mt-8 text-right">
              <p>以上</p>
              <p className="mt-4">制定日 2024年12月15日</p>
            </div>
          </div>
        </section>
      </div>
