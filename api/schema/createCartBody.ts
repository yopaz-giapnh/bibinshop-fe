 ...
 */
import type { CreateCartBodyPrivateMetadata } from './createCartBodyPrivateMetadata';
import type { CreateCartBodyPublicMetadata } from './createCartBodyPublicMetadata';

export type CreateCartBody = {
  /** The private metadata for the cart. */
  private_metadata?: CreateCartBodyPrivateMetadata;
  /** The public metadata for the cart. */
  public_metadata?: CreateCartBodyPublicMetadata;
};
