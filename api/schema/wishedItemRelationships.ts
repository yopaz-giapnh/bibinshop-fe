 ...
 */
import type { WishedItemRelationshipsVariant } from './wishedItemRelationshipsVariant';

export type WishedItemRelationships = {
  variant?: WishedItemRelationshipsVariant;
};
