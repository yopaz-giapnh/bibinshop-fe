 ...
 */
import type { CmsSectionRelationshipsLinkedResource } from './cmsSectionRelationshipsLinkedResource';

export type CmsSectionRelationships = {
  linked_resource?: CmsSectionRelationshipsLinkedResource;
};
