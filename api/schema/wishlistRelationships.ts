 ...
 */
import type { WishlistRelationshipsWishedItems } from './wishlistRelationshipsWishedItems';

export type WishlistRelationships = {
  wished_items?: WishlistRelationshipsWishedItems;
};
