 ...
 */
import type { StoreRelationshipsCmsPages } from './storeRelationshipsCmsPages';
import type { StoreRelationshipsDefaultCountry } from './storeRelationshipsDefaultCountry';
import type { StoreRelationshipsMenus } from './storeRelationshipsMenus';

export type StoreRelationships = {
  /** CMS Pages */
  cms_pages?: StoreRelationshipsCmsPages;
  /** Default Country of the Store */
  default_country?: StoreRelationshipsDefaultCountry;
  /** Menus */
  menus?: StoreRelationshipsMenus;
};
