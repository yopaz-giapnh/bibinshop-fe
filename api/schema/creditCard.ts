 ...
 */
import type { CreditCardAttributes } from './creditCardAttributes';
import type { CreditCardRelationships } from './creditCardRelationships';

export interface CreditCard {
  attributes: CreditCardAttributes;
  id: string;
  relationships: CreditCardRelationships;
  type: string;
}
